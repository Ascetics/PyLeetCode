...
class Solution:
    ...
    def zigzagLevelOrder(self, root: TreeNode):
        ...
        while len(q) > 0:
            ...
            q, left_to_right = q_sub, not left_to_right
        return res
...
if __name__ == '__main__':
    ...
    left, left_to_right = TreeNode(15), TreeNode(7)
    root = TreeNode(20)
    root.left, root.right = left, left_to_right
    left, left_to_right = TreeNode(9), root
    root = TreeNode(3)
    root.left, root.right = left, left_to_right
    root1 = root
